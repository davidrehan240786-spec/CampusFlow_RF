      ...
      >
        {articles.map((article) => (
          <motion.a
            ...
            className="group block overflow-hidden rounded-lg bg-white/5 border border-white/10 hover:border-white/20 transition-colors duration-300"
          ...
          >
            <div className="flex flex-col h-full">
              ...
              <div className="p-6 flex flex-col flex-grow">
                ...
                <div className="flex items-center text-sm font-medium text-white/60 mt-auto group-hover:text-white transition-colors">
                  {article.linkText}
